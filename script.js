...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('whatsapp-order').addEventListener('click', function() {
        ...
        const whatsappUrl = `https://api.whatsapp.com/send?phone=233595183757&text=${encodedMessage}`;
...
const productsWithInventory = [
    ...
    { 
        ...
        badge: "SELLING FAST", 
        description: "Heavenly angel costume with white robe, wings, and halo. Perfect for Christmas pageants or church events.", 
        pricing: "fixed", 
        price: 180,
        lowStockThreshold: 3
    },
    ...
    { 
        ...
        badge: "", 
        description: "Joseph costume with traditional tunic and headpiece. Complete the nativity scene with this authentic outfit.",
        pricing: "fixed", 
        price: 180,
        inventory: 13,
        lowStockThreshold: 3
    ...
    { 
        ...
        badge: "", 
        description: "Swashbuckling pirate costume with eye patch, hat, and toy sword. Perfect for adventure-themed parties.",
        pricing: "fixed", 
        price: 220,
        inventory: 14,
        lowStockThreshold: 3
    ...
    { 
        ...
        badge: "", 
        description: "Magical fairy costume with wings, wand, and glittery dress. Perfect for birthday parties and dress-up.",
        pricing: "fixed", 
        price: 150,
        inventory: 10,
        lowStockThreshold: 3
    ...
    { 
        ...
        badge: "", 
        description: "Fun dinosaur costume with tail and hood. Perfect for prehistoric-themed parties or everyday play.",
        pricing: "fixed", 
        price: 280,
        inventory: 17,
        lowStockThreshold: 3
    ...
    { 
        ...
        badge: "", 
        description: "Various animal costumes available including lion, tiger, and bear. Let your child explore the animal kingdom.",
        pricing: "fixed", 
        price: 250,
        inventory: 12,
        lowStockThreshold: 3
    ...
    { 
        ...
        badge: "", 
        description: "Realistic firefighter helmet. Durable and comfortable for extended wear during play.",
        pricing: "fixed", 
        price: 100,
        inventory: 18,
        lowStockThreshold: 3
    ...
    { 
        ...
        badge: "", 
        description: "Classic chef hat and apron set. Perfect for aspiring chefs or kitchen play.",
        pricing: "fixed", 
        price: 90,
        inventory: 22,
        lowStockThreshold: 3
    ...
    { 
        ...
        badge: "", 
        description: "Sparkling magic wand and fairy dust. Perfect for princess, fairy, or wizard costumes.",
        pricing: "fixed", 
        price: 70,
        inventory: 28,
        lowStockThreshold: 3
    ...
    { 
        ...
        badge: "", 
        description: "Regal crown and scepter set. Perfect for kings, queens, princes, or princesses.",
        pricing: "fixed", 
        price: 85,
        inventory: 20,
        lowStockThreshold: 3
    ...
    { 
        ...
        badge: "", 
        description: "Pilot cap and aviator glasses. Complete any pilot or aviation-themed costume.",
        pricing: "fixed", 
        price: 95,
        inventory: 15,
        lowStockThreshold: 3
